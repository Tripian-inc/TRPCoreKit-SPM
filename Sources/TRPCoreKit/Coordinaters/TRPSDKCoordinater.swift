...
//        self.navigationController.navigationBar.setNexusBar()
    ...
    private func setupSomeGeneralAppearances() {
        UIView.appearance(whenContainedInInstancesOf: [UIAlertController.self]).tintColor = TRPColor.ultraLightGrey
...
extension TRPSDKCoordinater: TRPCreateTripCoordinaterDelegate {
    ...
    public func trpTripCreateCoordinaterOpenMyTrip(hash: String, city: TRPCity, destinationId: String) {
...
extension TRPSDKCoordinater: MyTripVCDelegate {
    ...
    public func myTripOpenTrip(hash: String, city: TRPCity, arrival: String, departure: String, destinationId: String) {
        
        let startDay = startTripWithCurentDay(arrival: arrival, departure: departure)
        openTripModeViewController(hash: hash, city: city, startDay: startDay, destinationId: destinationId)
    }
    ...
    public func createNewTripPressed(_ myTrip: MyTripVC, startDate: String?, endDate: String?, city: TRPCity?, meetingPoint: String?, destinationId: String?) {
        setupCreteTripCoordinater()
...
extension TRPSDKCoordinater {
    ...
    private func openTripModeViewController(hash:String,
        ...
        tripCoordinater.openTripModeVC(hash: hash, city: city, destinationId: destinationId, startDay: startDay)
