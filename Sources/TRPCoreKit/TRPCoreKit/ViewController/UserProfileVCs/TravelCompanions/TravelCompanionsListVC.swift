...
extension TravelCompanionsListVC{
    ...
    fileprivate func showRemoveAlert(companionName: String?, companionId: Int, indexPath: IndexPath) {
        ...
        showConfirmAlert(title: "", message: text.toLocalized(), confirmTitle: "Delete", cancelTitle: "Cancel", btnConfirmAction: {
            self.viewModel.removeCompanion(companionId: companionId, indexPath: indexPath)
