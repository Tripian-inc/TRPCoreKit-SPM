...
final class ExperiencesViewModel: TableViewViewModelProtocol {
    ...
    public init(cityName: String, destinationId: String) {
    ...
    public func start() {
        ...
        fetchJuniperTours(startDate: tourDates.startDate, endDate: tourDates.endDate, destinationId: Int(destinationId)!)
    }
