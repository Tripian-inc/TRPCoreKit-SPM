...
public class FavoritesVC: TRPBaseUIViewController {
    ...
    public override func viewDidLoad() {
        super.viewDidLoad()
        title = TRPLanguagesController.shared.getLanguageValue(for: "trips.myTrips.itinerary.favorites.title")
    }
...
extension FavoritesVC: UITableViewDelegate, UITableViewDataSource{
    ...
    fileprivate func setupTableView() {
        tb.setEmptyText(TRPLanguagesController.shared.getLanguageValue(for: "trips.myTrips.itinerary.favorites.emptyMessage"))
