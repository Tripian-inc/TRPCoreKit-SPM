...
public class TRPRouteCalculator {
    ...
    public var directionProfile: DirectionProfile = .walking
    ...
    private func calculate(_ directionProfile: DirectionProfile,_ mWayPoints:[TRPLocation]) {
        ...
        var mapBoxProfileIdentify: DirectionsProfileIdentifier = .walking
        
        //Yeni bir tip eklenirse burası değiştirilecek
        switch directionProfile {
        case .automobile:
            mapBoxProfileIdentify = .cycling
            break;
        case .walking:
        ...
        let directions = Directions(credentials: DirectionsCredentials(accessToken: providerApiKey))
        ...
        _ = directions.calculate(options) { (session, result) in
            ...
            case .success(let routeResponse):
                ...
                if self.routeErrorStatus == .walking {
                    ...
                    self.calculate(DirectionProfile.walking, newCalculatedWayPoints)
                    return
                }
