...
public protocol MyTripVCDelegate: AnyObject {
    func createNewTripPressed(_ myTrip: MyTripVC, startDate: String?, endDate: String?, city: TRPCity?, meetingPoint: String?, destinationId: String?)
    func myTripOpenTrip(hash: String, city: TRPCity, arrival:String, departure:String, destinationId: String)
...
extension MyTripVC: MyTripTableViewVCDelegate {
    ...
    public func myTripTableViewVCSelectedTrip(hash: String, city: TRPCity, arrival: String, departure: String, destinationId: String) {
...
extension MyTripVC: MyTripViewModelDelegate {
    public func callCreateTripWithDestination(startDate: String, endDate: String, city: TRPCity, destinationId: String) {
