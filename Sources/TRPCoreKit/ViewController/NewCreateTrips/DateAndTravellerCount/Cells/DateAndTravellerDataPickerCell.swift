...
extension DateAndTravellerDataPickerCell {
    private func setupToolBar() {
        let setTimeTitle = TRPAppearanceSettings.Common.ApplyButtonTitle
        ...
        timePickerText.inputAccessoryView = timePicker.getToolBar(with: TRPAppearanceSettings.Common.ApplyButtonTitle, TRPAppearanceSettings.Common.barButtonForInputButtonColor)
    }
