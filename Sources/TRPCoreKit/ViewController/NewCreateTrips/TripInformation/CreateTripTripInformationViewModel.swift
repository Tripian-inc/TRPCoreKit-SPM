...
extension CreateTripTripInformationViewModel {
    ...
    private func createData() -> [CreateTripTripInformationSectionModel]{
        ...
        let destinationCell = CreateTripTripInformationCellModel(title: "Select destination from list", contentType: .destination)
        sections.append(CreateTripTripInformationSectionModel(title: "Where are you going", cells: [destinationCell], isRequired: true))
        let arrivalDateCell = CreateTripTripInformationCellModel(title: "Arrival", contentType: .arrivalDate)
        let departureDateCell = CreateTripTripInformationCellModel(title: "Departure", contentType: .departureDate)
        sections.append(CreateTripTripInformationSectionModel(title: "Select dates", cells: [arrivalDateCell, departureDateCell]))
        let arrivalHourCell = CreateTripTripInformationCellModel(title: "Arrival", contentType: .arrivalHour)
        let departureHourCell = CreateTripTripInformationCellModel(title: "Departure", contentType: .departureHour)
        sections.append(CreateTripTripInformationSectionModel(title: "Select hours", cells: [arrivalHourCell, departureHourCell]))
        return sections
    }
}
...
extension CreateTripTripInformationViewModel {
    public func canContinue() -> Bool {
        guard let selectedCity = selectedCity else {
            self.delegate?.viewModel(showMessage: "Select destination city", type: .error)
            return false
        }
