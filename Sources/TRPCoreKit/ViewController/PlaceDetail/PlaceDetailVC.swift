...
extension PlaceDetailVC{
    ...
    func showReportAProblem(_ data: [TRPProblemCategoriesInfoModel]) {
        ...
        let cancelButton = UIAlertAction(title: "Cancel".toLocalized(), style: UIAlertAction.Style.cancel, handler: nil)
    ...
    func openInputTextForProblem(_ problem: TRPProblemCategoriesInfoModel) {
        ...
        let cancel = UIAlertAction.init(title: "Cancel", style: .cancel, handler: {_ in })
