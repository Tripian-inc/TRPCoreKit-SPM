...
public class CompanionDetailVM {
    ...
    private final let titleSectionName = TRPLanguagesController.shared.getLanguageValue(for: "user.travelCompanions.companionTitle")
    private final let nameSectionName = TRPLanguagesController.shared.getLanguageValue(for: "user.travelCompanions.companionName")
    private final let ageSectionName = TRPLanguagesController.shared.getLanguageValue(for: "user.travelCompanions.companionAge")
    var titleQuestions: [PersonalPreference] = [
        .init(id: 889911, name: TRPLanguagesController.shared.getLanguageValue(for: "family_member")),
        .init(id: 889912, name: TRPLanguagesController.shared.getLanguageValue(for: "friend")),
        .init(id: 889913, name: TRPLanguagesController.shared.getLanguageValue(for: "work_colleague"))
    ]
...
extension CompanionDetailVM {
    ...
    private func addTextFields(){
        let nameCell = CompanionDetailMenu(menuId: nameSectionId, name: TRPLanguagesController.shared.getLanguageValue(for: "type_name"), menuType: .textField, value: "", companionPrefs: [PersonalPreference(id: 1, name: nameSectionName)])
        let nameSection = CompanionDetailSectionModel(title: nameSectionName, cells: [nameCell])
        sectionModels.append(nameSection)
        let ageCell = CompanionDetailMenu(menuId: ageSectionId, name: TRPLanguagesController.shared.getLanguageValue(for: "type_age"), menuType: .textField, value: "", companionPrefs: [PersonalPreference(id: 2, name: ageSectionName)])
