...
#ifndef TRPRESTKIT_SWIFT_H
#define TRPRESTKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TRPRestKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC10TRPRestKit11RestKitInfo")
@interface RestKitInfo : NSObject
...
SWIFT_CLASS("_TtC10TRPRestKit19TRPCityWeatherModel")
@interface TRPCityWeatherModel : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC10TRPRestKit13TRPImageModel")
@interface TRPImageModel : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC10TRPRestKit25TRPUserFeedbackReplyModel")
@interface TRPUserFeedbackReplyModel : NSObject
@end
