...
extension Notification.Name {
    ...
    public static let tripDeleted = Notification.Name("TRPAnalytics.tripDeleted")
    public static let mapViewed = Notification.Name("TRPAnalytics.mapViewed")
    public static let userLocated = Notification.Name("TRPAnalytics.userLocated")
    public static let favoriteStatusChanged = Notification.Name("TRPAnalytics.favoriteStatusChanged")
}
