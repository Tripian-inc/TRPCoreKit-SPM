    ...
    func addPlaceType() -> AddPlaceTypes {
        ...
        case .attractions:
            return AddPlaceTypes(id: TRPPoiCategory.attractions.getId(),
                                 name: TRPLanguagesController.shared.getLanguageValue(for: "trips.myTrips.exploreMore.categories.attractions"),
        ...
        case .restaurants:
            return AddPlaceTypes(id: TRPPoiCategory.restaurants.getId(),
                                 name: TRPLanguagesController.shared.getLanguageValue(for: "trips.myTrips.exploreMore.categories.restaurants"),
                                 description: "Cuisine, brunch, vegetarian, etc.",
                                 condition: "",
                                 order: 11, subTypes: [16,40])
        case .nightLife:
            return AddPlaceTypes(id: TRPPoiCategory.nightLife.getId(),
                                 name: TRPLanguagesController.shared.getLanguageValue(for: "trips.myTrips.exploreMore.categories.nightlife"),
        ...
        case .cafes:
            return AddPlaceTypes(id: TRPPoiCategory.cafes.getId(),
                                 name: TRPLanguagesController.shared.getLanguageValue(for: "trips.myTrips.exploreMore.categories.cafes"),
...
public enum TRPPoiCategory: String, CaseIterable {
    ...
    func getSingler() -> String {
        switch self {
        case .attractions:
            return TRPLanguagesController.shared.getLanguageValue(for: "trips.myTrips.exploreMore.categories.attractions")
        case .restaurants:
            return TRPLanguagesController.shared.getLanguageValue(for: "trips.myTrips.exploreMore.categories.restaurants")
        case .nightLife:
            return TRPLanguagesController.shared.getLanguageValue(for: "trips.myTrips.exploreMore.categories.nightlife")
        case .coolFinds:
            return "Cool Find"
        case .cafes:
            return TRPLanguagesController.shared.getLanguageValue(for: "trips.myTrips.exploreMore.categories.cafes")
