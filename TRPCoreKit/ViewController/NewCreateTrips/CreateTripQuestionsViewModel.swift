...
class CreateTripQuestionsViewModel {
    ...
    internal var sectionModels: [SelectableQuestionModelNew] = []
    ...
    public func isSelectedAnswer(id: Int) -> Bool {
    ...
    internal func removeSelectedItem(id: Int) {
        if selectedItems.contains(id) {
            selectedItems.remove(element: id)
        }
    }
    
    internal func removeAllSelectedItemsForSection(section: SelectableQuestionModelNew) {
        section.answers.forEach { answer in
            self.removeSelectedItem(id: answer.id)
        }
    }
    
    internal func insertSelectedItem(_ answer: SelectableAnswer) {
        if !self.selectedItems.contains(answer.id) {
...
extension CreateTripQuestionsViewModel {
    ...
    public func setTripProperties() {
        ...
        tripProfile.tripAnswers = selectedItems
...
public enum SelectableQuestionCellType {
    case withDescription, restaurant, checkbox, radio
}
