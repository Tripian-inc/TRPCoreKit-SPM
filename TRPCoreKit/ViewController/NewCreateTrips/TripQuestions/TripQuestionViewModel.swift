...
extension TripQuestionViewModel {
    ...
    private func lunchAndDinnerController(_ selectableQuestion: [SelectableQuestionModel]) -> [SelectableQuestionModel]{
        ...
        //Add fake title
        let onlyTitle = SelectableQuestionModel(id: 99999, questionCategory: TRPLanguagesController.shared.getLanguageValue(for: "trips.createNewTrip.restaurantQuestion.title"))
        ...
        if let dinner = selectableQuestion.first(where: {$0.id == dinnerQuestionId}) {
            let dinnerModel = SelectableQuestionModel(id: dinner.id,
                                                      questionCategory: TRPLanguagesController.shared.getLanguageValue(for: "trips.createNewTrip.restaurantQuestion.dinner"),
        ...
        if let lunch = selectableQuestion.first(where: {$0.id == lunchQuestionId}) {
            let lucnhModel = SelectableQuestionModel(id: lunch.id,
                                                      questionCategory: TRPLanguagesController.shared.getLanguageValue(for: "trips.createNewTrip.restaurantQuestion.lunchBrunch"),
