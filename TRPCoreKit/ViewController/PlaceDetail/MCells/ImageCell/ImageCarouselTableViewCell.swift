...
final public class ImageCarouselTableViewCell: UITableViewCell {
...
extension ImageCarouselTableViewCell {
    ...
    func setupCollectionConstraints() {
        ...
        self.collectionViewLayout!.itemSize = CGSize(width: self.contentView.frame.width, height: 300)
        ...
        NSLayoutConstraint.activate([
                                        ...
                                        self.collectionView!.bottomAnchor.constraint(equalTo: bottomAnchor, constant: 20),
